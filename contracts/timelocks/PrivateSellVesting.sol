...
/**
 * @title PrivateSellVesting
 */
contract PrivateSellVesting is TokenVesting {
    /**
    ...
    {
        // Let the crowdsale contract transfer tokens from vesting
        _token.approve(_operator, _tokensPerPeriod * _numberOfPeriods);
    }
}
